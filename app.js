...
function rowcol() {                                 //checking the number of rows and columns
    ...
    if (row1 < 2 || col1 < 2 || row1 > 5 || col1 > 5) {
        ...
        Clickbutton.setAttribute("onclick", "setmatrices()")
        document.getElementById('vals').appendChild(Clickbutton)
...
function addscalor() {                          //function to get scalor to add to matrix
    ...
    addsc.innerHTML = '<label for="addsc">Enter scalor number to add to the matrix: </label><input type="number" name="" id="addsc"><button onclick="sumscalor()">Click</button>'
...
function multiplyscalor() {                     //function to get scalor to multiply to matrix
    ...
    mulsc.innerHTML = '<label for="mulsc">Enter scalor number to Multiply to the matrix: </label><input type="number" name="" id="mulsc"><button onclick="mulscalor()">Click</button>'
...
function rowcol1() {                                    //for getting rows and columns of 2 matrices
    ...
    if (row1 < 2 || col1 < 2 || row1 > 5 || col1 > 5 || row2 < 2 || col2 < 2 || row2 > 5 || col2 > 5) {
        ...
        var Clickbutton = document.createElement('button')
        Clickbutton.innerHTML = 'Click'
        Clickbutton.setAttribute("onclick", "setmatrices2()")
        document.getElementById('vals').appendChild(Clickbutton)
